...
export async function ensureDefaultTeamAndCoach() {
  try {
    ...
    console.error('ensureDbReady error in ensureDefaultTeamAndCoach:', err);
  }
  ...
  try {
    ...
    console.error('ensureDefaultTeamAndCoach team1 error:', err);
  }
  ...
  try {
    ...
    console.error('ensureDefaultTeamAndCoach coach1 error:', err);
  }
  ...
  try {
    ...
    console.error('ensureDefaultTeamAndCoach team2 error:', err);
  }
  ...
  try {
    ...
    console.error('ensureDefaultTeamAndCoach coach2 error:', err);
  }
  ...
  try {
    ...
    console.error('ensureDefaultTeamAndCoach admin error:', err);
  }
  ...
  try {
    ...
    console.error('ensureDefaultTeamAndCoach arm error:', err);
  }
